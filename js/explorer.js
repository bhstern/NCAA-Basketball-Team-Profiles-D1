...
const EXPLORER_TIPS = {
  ...
  tov_sensitivity:'Turnover % × usage — how damaging turnovers are given role.',
  ...
  midrange_rate:'Midrange attempt rate as share of FGA.',midrange_fg_pct:'Midrange FG%.',
...
const EXPLORER_STAT_TABS = {
  ...
  advanced:[
    ...
    {key:'tov_sensitivity',fmt:v=>fmtNumE(v,3),label:'TOV\nSensitivity'},
  ...
  context:[
    ...
    {key:'rim_rate_delta_team',fmt:v=>fmtSignE(v,2),label:'Rim\nvs Team'},
    {key:'three_rate_delta_team',fmt:v=>fmtSignE(v,2),label:'3PT\nvs Team'},
